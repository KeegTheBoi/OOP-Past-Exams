...
public class Test {
	 ...
	 * 
	 * ATTENZIONE: E' considerato obbligatorio evitare le principali ripetizioni
	 * 
	 * Sono considerati invece opzionali ai fini della possibilità di correggere
	 * l'esercizio, ma concorrono comunque al raggiungimento della totalità del
	 * punteggio: 
	 * 
	 * - implementazione dell'ultimo test, chiamati optionalTestXYZ (relativo al
	 * metodo BatteryFactory.createSecureAndRechargableBattery) 
	 * 
