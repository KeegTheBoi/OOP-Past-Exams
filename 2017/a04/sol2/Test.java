...
public class Test {
	 ...
	 * 
	 * 1 all'inizio del gioco si tirino 5 dadi (numeri random compresi fra 1 e 6 inclusi) mostrandoli nei pulsanti
	 ...
	 * 4 si riabilitano tutti i pulsanti e si stampa a video il risultato conseguito (vedere sotto)
	 * 5 si ricominci dal punto 2 sopra, indefinitamente
	 * 
	 * I risultati possibili (che non dipendono dall'ordine dei dati) sono i seguenti:
	 ...
	 * - THREE (tre dadi uguali, e gli diversi, ad esempio: 1,2,3,1,1 o 4,3,4,2,4)
