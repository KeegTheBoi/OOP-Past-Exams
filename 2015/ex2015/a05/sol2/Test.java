...
public class Test {
     ...
     * che realizza una scacchiera con pedine nella riga in alto (pulsante con label "O"). Il costruttore di GUI deve prendere in 
     * ingresso il numero di righe e colonne (si assumano entrambi maggiori di 2).
     * Clickando su una pedina, questa scende verticalmente di 2 caselle la prima volta, poi di una sola casella alla volta.
     * Arrivata in fondo non la si sposta più. Le pdine possono essere mosse indipendentemente le une dalle altre.
     * Quanto tutte sono i nfondo il "gioco" finisce, mostrando una JDialog e poi uscendo
     * 
