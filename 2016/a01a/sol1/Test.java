 ...
 * Al momento di costruire la sequenza, si può accettare un filtro per verificare che tutti gli elementi abbiano certe caratteristiche.
 * 
 * Le interfacce menzionano la classe java.util.Optional<X>, usato per contenere o meno un elemento di tipo X. Si ricorda
