...
public class Test {
     ...
     * (ossia per visualizzare un 2 abiliterà il solo pulsante con scritta 2, ossia il terzo):
     * premendo tale pulsante, la GUI mostrerà quello successivo (letto da file) e così via.
    ...
    public static void main(String[] args) throws Exception {
        new GUI("src/ex2016/a01b/e2/b.txt",10); // Si noti che questo file è presente nella cartella di questo file java 
    }
}
